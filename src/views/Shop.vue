        ...
        <div class="col-md-3 col-sm-6" v-for="product in products" :key="product.id">
            <div class="product-grid9">
                ...
                <div class="product-content">
                    ...
                    <div class="price"> {{ product.tags}}</div>
...
.product-grid2 .product-image2 img{width:100%;height:300px}
...
.product-grid3 .product-image3 img{width:100%;height:300px}
...
.product-grid4 .product-image4 img{width:100%;height:300px}
...
.product-grid5 .product-image5 img{width:100%;height:300px}
...
.product-grid7 .product-image7 img{width:100%;height:300}
...
.product-grid8 .product-image8 img{width:100%;height:300px}
